...
**Idioma:** [English](FREE-CONNECTION-GUIDE.md) · **Español**
...
ChatGPT no se conecta directamente a un MCP local ordinario. Si tu objetivo es exclusivamente ChatGPT, usa una de las opciones remotas siguientes y comprueba primero que tu plan permita la capacidad que necesitas.
...
Las cuentas personales de GitHub incluyen una cuota mensual gratuita de Codespaces. Consulta siempre la cuota vigente de tu cuenta antes de depender de ella.
...
La parte de servidor puede costar 0 €, pero el acceso MCP de ChatGPT depende del plan y de las capacidades disponibles en tu cuenta.
...
3. En ChatGPT, habilita el modo desarrollador si tu plan lo permite.
...
6. Revisa cuidadosamente los permisos antes de habilitar acciones de escritura.
...
- **Local (`stdio`) → 0 €** para uso personal y máxima privacidad.
- **Render Free → 0 € de hosting** para una URL remota de pruebas, con las limitaciones del plan gratuito.
- **GitHub Codespaces → 0 € dentro de la cuota incluida** para desarrollo temporal en la nube.
- **ChatGPT:** comprueba primero la disponibilidad MCP de tu plan.
